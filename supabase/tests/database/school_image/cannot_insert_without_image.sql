...
select throws_ok('insert_image', '23502', 'null value in column "image_id" of relation "school_image" violates not-null constraint', 'users should not be able to insert a school image without linking to an image');
